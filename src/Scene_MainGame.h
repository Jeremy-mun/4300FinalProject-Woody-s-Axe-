...
protected:
    ...
    sf::Sprite             parallaxDemon1, parallaxDemon2, parallaxDemon3, parallaxDemon0;
    ...
    std::vector<sf::String> m_parallaxDemonBackgroundTextures = { "TexParallaxDemon0" , "TexParallaxDemon1" ,"TexParallaxDemon2" ,"TexParallaxDemon3" };
    std::vector<sf::Sprite> m_parallaxDemonBackgroundSprites = { parallaxDemon0, parallaxDemon1, parallaxDemon2, parallaxDemon3 };
